window.onload = () => {
  ...
  // const handShakeLoginWidget =
  const widgetContainer = document.getElementById('loginFrameDiv');
  const widget = window.document.createElement('iframe');
  (widgetContainer || window.document.body).appendChild(widget);
